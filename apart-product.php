		 	...
		 	<div class="apart-form">
		 		<div class="container" style="width: 850px;">
		 			<div class="our-room" style="margin-bottom: 10px;">
				 		<h5 style="margin-left: -15px;"><i class="fa fa-arrow-left" aria-hidden="true" onclick="goBack()" style="color: #D97B34 !important; border-right: 1px solid; padding-left: 0px; padding-right: 15px;"></i><span style="padding-left: 15px; font-size: 24px;">Junior Suite</span></h5>
				 	</div>
				 	<script>
						function goBack() {
						  window.history.back();
				 			...
				 			<div id="carousel-thumb" class="carousel slide carousel-fade carousel-thumbnails" data-ride="carousel">
						      	<div class="carousel-inner" role="listbox">
							        <div class="carousel-item active">
							          <img class="d-block" src="/php-project/img/72.jpg" alt="First slide">
							        </div>
							        <div class="carousel-item">
							          <img class="d-block" src="/php-project/img/73.jpg" alt="Second slide">
							        </div>
							        <div class="carousel-item">
							          <img class="d-block" src="/php-project/img/74.jpg" alt="Third slide">
							        </div>
							        <div class="carousel-item">
							          <img class="d-block" src="/php-project/img/75.jpg" alt="Third slide">
							        </div>
							        <div class="carousel-item">
							          <img class="d-block" src="/php-project/img/71.jpg" alt="Third slide">
							        </div>							    
						      	</div>
							    ...
							    <a class="carousel-control-next" href="#carousel-thumb" role="button" data-slide="next">
						      	...
						      	<ol class="carousel-indicators">
						        	<li data-target="#carousel-thumb" data-slide-to="0" class="active">
						        		<img class="d-block w-100" src="/php-project/img/72.jpg"
						            	class="img-fluid">
						        	</li>
						        	<li data-target="#carousel-thumb" data-slide-to="1">
						        		<img class="d-block w-100" src="/php-project/img/73.jpg"
						            	class="img-fluid">
						            </li>
						        	<li data-target="#carousel-thumb" data-slide-to="2">
						        		<img class="d-block w-100" src="/php-project/img/74.jpg"
						            	class="img-fluid">
						            </li>
						            <li data-target="#carousel-thumb" data-slide-to="3">
						            	<img class="d-block w-100" src="/php-project/img/75.jpg"
							            class="img-fluid">
							        </li>
						            <li data-target="#carousel-thumb" data-slide-to="4">
						            	<img class="d-block w-100" src="/php-project/img/71.jpg"
						            	class="img-fluid">
						            </li>
						      	</ol>
						    </div>
						    <div class="table" style="margin-top: 40px;">
							    <table width="100%">
							    	<tbody>
							    		<tr>
							    			<th>Properties:</th>
							    			<td><p>Accommodates: 2</p><p> Beds: 2 Double(s)</p></td>
							    			<td>Size: 260 sq ft</td>
							    		</tr>
							    	</tbody>
							    </table>
							    <hr>
							    <table width="100%"> 
							    	<tbody>
							    		<tr>
							    			...
							    			<td width="72%">Affordable luxury. Our Junior Suites are the perfect option if you’re looking for a little extra luxury. With an open 400 square foot floor plan, the Junior Suites offer the extra space you need to spread out and enjoy the breathtaking views of the city skyline.</td>
							    		</tr>
							    	</tbody>
							    </table>							    							    	
							    <hr>
							    		...
							    		<tr>
							    			...
							    			<td width="36%">
							    				<ul style="list-style-type:none; margin-left: -25px;">
							    					<li><i class='far fa-snowflake'></i>A/C</li>
							    			...
							    			<td width="36%">
							    				<ul style="list-style-type:none; margin-left: -25px;">
							    					...
							    					<li><i class="fa fa-window-maximize"></i>Safe</li>
							    					<li><i class="fa fa-phone" aria-hidden="true"></i>Telephone</li>
							    					<li><i class="fas fa-person-booth"></i>Towels</li>
							    				</ul>
							    			</td>
							    		</tr>
							    	</tbody>
				 		...
				 		<div class="apart-right" style="width: 27%;">
				 			<div class="border-all" style="border: 1px solid #F2CFB5; padding: 18px; position: sticky; top: 20px;">
				 				<span style="border-left: 1px solid #F2CFB5; padding-left: 13px; height: 75px;display: grid; margin:5px 0px 25px 0px; color: #000 !important; ">
				 					...
				 					<price style="margin-bottom: 0px; color: #000 !important; font-size: 30px;" id="price">$250</price>
