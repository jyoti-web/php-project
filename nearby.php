	...
	<div class="nearby-me">
		...
		<section class="mission" style="height: 350px;">
			<div class="container" style="width: 850px;">
				<div class="row">
					<div class="col-sm-6">
						<img src="/php-project/img/51.jpg" width="400px" height="350px;" style="object-fit: cover;">
					</div>
					<div class="col-sm-6" id="list">
		...
		<section class="castro" style="background-color: #F6F6F6; height: 350px;" >
			<div class="container" style="width: 850px;">
				<div class="row">
					...
					<div class="col-sm-6">
						<img src="/php-project/img/52.jpg" width="400px" height="350px;" style="object-fit: cover;">
					</div>					
				</div>
			</div>
		</section>
		<section class="mission" style="height: 390px;">
			<div class="container" style="width: 850px;">
				<div class="row">
					<div class="col-sm-6">
						<img src="/php-project/img/53.jpg" width="400px" height="390px;" style="object-fit: cover;">
					</div>
					<div class="col-sm-6" id="list">
		...
		<section class="castro" style="background-color: #F6F6F6; height: 350px;" >
			<div class="container" style="width: 850px;">
				<div class="row">
					...
					<div class="col-sm-6">
						<img src="/php-project/img/54.jpg" width="400px" height="350px;" style="object-fit: cover;">
					</div>					
				</div>
			</div>
		</section>
		<section class="mission" style="height: 390px;">
			<div class="container" style="width: 850px;">
				<div class="row">
					<div class="col-sm-6">
						<img src="/php-project/img/55.jpg" width="400px" height="390px;" style="object-fit: cover;">
					</div>
					<div class="col-sm-6" id="list">
